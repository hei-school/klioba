package school.hei.klioba.model.psp.vola.api.gen.client;
...
import school.hei.klioba.model.psp.vola.api.gen.client.auth.ApiKeyAuth;
import school.hei.klioba.model.psp.vola.api.gen.client.auth.Authentication;
import school.hei.klioba.model.psp.vola.api.gen.client.auth.HttpBasicAuth;
import school.hei.klioba.model.psp.vola.api.gen.client.auth.OAuth;

@Component("school.hei.klioba.model.psp.vola.api.gen.client.ApiClient")
public class ApiClient {
  ...
  public <T> ResponseEntity<T> invokeAPI(
    ...
    final BodyBuilder requestBuilder =
        RequestEntity.method(method, builder.build().encode().toUri());
    if (accept != null) {
